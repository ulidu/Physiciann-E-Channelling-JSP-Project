...
<body>
    ...
    <body class="single-page1">
        <header class="site-header1" style="height: 1000px;">
            <div class="nav-bar">
                <div class="container">
                    <div class="row">
                        <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <nav class="site-navigation d-flex justify-content-end align-items-center">
                                <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-items-center">
                                    ...
                                    <li class="current-menu-item"><a href="members.jsp">Members</a></li>
            ...
            <!-- Sign up form -->
            <section style="position: relative; top: -50px;" class="signup">
                    ...
                    <div class="row">
                        <div style="position: relative; left: 34%;" class="col-12 col-md-6 col-lg-4">
                            <div class="foot-about">
                                ...
                                <p align=center>Copyright © Physiciann PLC. <br>No.333, Physiciann Street, Colombo, Sri Lanka. <br>All rights reserved.<br><br>No.08, Physiciann Street, Colombo.<br>physiciann@gmail.com</p>
